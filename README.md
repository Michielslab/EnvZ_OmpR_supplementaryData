...
The indivdual .csv files include the raw OD data as exported from the Cerillo OD595 readers where cells are either exposed to PQ or H202 (3 different biological replicates/condition). These files are imported in the R script 
